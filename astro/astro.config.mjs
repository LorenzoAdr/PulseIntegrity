...
// (ASTRO_LOCAL_BASE=1 → base "/"). Build y preview usan /PulseIntegrity/ (GitHub Pages del repo PulseIntegrity).
const base = process.env.ASTRO_LOCAL_BASE === '1' ? '/' : '/PulseIntegrity/';
